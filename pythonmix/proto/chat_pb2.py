...
_PINGPONG_T = _descriptor.Descriptor(
  name='PingPong_t',
  full_name='grpc.PingPong_t',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num', full_name='grpc.PingPong_t.num', index=0,
...
DESCRIPTOR.message_types_by_name['PingPong_t'] = _PINGPONG_T
...
PingPong_t = _reflection.GeneratedProtocolMessageType('PingPong_t', (_message.Message,), {
  'DESCRIPTOR' : _PINGPONG_T,
  '__module__' : 'chat_pb2'
  # @@protoc_insertion_point(class_scope:grpc.PingPong_t)
  })
_sym_db.RegisterMessage(PingPong_t)
...
_CHATSERVER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='PingPong',
    full_name='grpc.ChatServer.PingPong',
    index=2,
    containing_service=None,
    input_type=_PINGPONG_T,
    output_type=_PINGPONG_T,
    serialized_options=None,
  ),
])
