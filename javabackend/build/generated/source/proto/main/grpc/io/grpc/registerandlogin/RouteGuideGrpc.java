...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point,
      io.grpc.registerandlogin.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = io.grpc.registerandlogin.Point.class,
      responseType = io.grpc.registerandlogin.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point,
      io.grpc.registerandlogin.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point, io.grpc.registerandlogin.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod =
              io.grpc.MethodDescriptor.<io.grpc.registerandlogin.Point, io.grpc.registerandlogin.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.Point.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.registerandlogin.Rectangle,
      io.grpc.registerandlogin.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = io.grpc.registerandlogin.Rectangle.class,
      responseType = io.grpc.registerandlogin.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.registerandlogin.Rectangle,
      io.grpc.registerandlogin.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<io.grpc.registerandlogin.Rectangle, io.grpc.registerandlogin.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod =
              io.grpc.MethodDescriptor.<io.grpc.registerandlogin.Rectangle, io.grpc.registerandlogin.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point,
      io.grpc.registerandlogin.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = io.grpc.registerandlogin.Point.class,
      responseType = io.grpc.registerandlogin.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point,
      io.grpc.registerandlogin.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<io.grpc.registerandlogin.Point, io.grpc.registerandlogin.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<io.grpc.registerandlogin.Point, io.grpc.registerandlogin.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.RouteSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.registerandlogin.RouteNote,
      io.grpc.registerandlogin.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = io.grpc.registerandlogin.RouteNote.class,
      responseType = io.grpc.registerandlogin.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.registerandlogin.RouteNote,
      io.grpc.registerandlogin.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<io.grpc.registerandlogin.RouteNote, io.grpc.registerandlogin.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod =
              io.grpc.MethodDescriptor.<io.grpc.registerandlogin.RouteNote, io.grpc.registerandlogin.RouteNote>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RouteChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.RouteNote.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.RouteNote.getDefaultInstance()))
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(io.grpc.registerandlogin.Point request,
        io.grpc.stub.StreamObserver<io.grpc.registerandlogin.Feature> responseObserver) {
     ...
     * </pre>
     */
    public void listFeatures(io.grpc.registerandlogin.Rectangle request,
        io.grpc.stub.StreamObserver<io.grpc.registerandlogin.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.grpc.registerandlogin.Point> recordRoute(
        io.grpc.stub.StreamObserver<io.grpc.registerandlogin.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.grpc.registerandlogin.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<io.grpc.registerandlogin.RouteNote> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.grpc.registerandlogin.Point,
                io.grpc.registerandlogin.Feature>(
                  this, METHODID_GET_FEATURE)))
          .addMethod(
            getListFeaturesMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                io.grpc.registerandlogin.Rectangle,
                io.grpc.registerandlogin.Feature>(
          ...
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                io.grpc.registerandlogin.Point,
                io.grpc.registerandlogin.RouteSummary>(
                  this, METHODID_RECORD_ROUTE)))
          .addMethod(
            getRouteChatMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                io.grpc.registerandlogin.RouteNote,
                io.grpc.registerandlogin.RouteNote>(
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public io.grpc.registerandlogin.Feature getFeature(io.grpc.registerandlogin.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<io.grpc.registerandlogin.Feature> listFeatures(
        io.grpc.registerandlogin.Rectangle request) {
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractFutureStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.registerandlogin.Feature> getFeature(
        io.grpc.registerandlogin.Point request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((io.grpc.registerandlogin.Point) request,
              (io.grpc.stub.StreamObserver<io.grpc.registerandlogin.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((io.grpc.registerandlogin.Rectangle) request,
              (io.grpc.stub.StreamObserver<io.grpc.registerandlogin.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.registerandlogin.RouteGuideProto.getDescriptor();
    }
