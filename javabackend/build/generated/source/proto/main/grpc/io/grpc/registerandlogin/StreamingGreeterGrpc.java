...
public final class StreamingGreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.registerandlogin.SteamRequest,
      io.grpc.registerandlogin.SteamRequest> getSayHelloStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHelloStreaming",
      requestType = io.grpc.registerandlogin.SteamRequest.class,
      responseType = io.grpc.registerandlogin.SteamRequest.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.registerandlogin.SteamRequest,
      io.grpc.registerandlogin.SteamRequest> getSayHelloStreamingMethod() {
    io.grpc.MethodDescriptor<io.grpc.registerandlogin.SteamRequest, io.grpc.registerandlogin.SteamRequest> getSayHelloStreamingMethod;
      ...
      synchronized (StreamingGreeterGrpc.class) {
        if ((getSayHelloStreamingMethod = StreamingGreeterGrpc.getSayHelloStreamingMethod) == null) {
          StreamingGreeterGrpc.getSayHelloStreamingMethod = getSayHelloStreamingMethod =
              io.grpc.MethodDescriptor.<io.grpc.registerandlogin.SteamRequest, io.grpc.registerandlogin.SteamRequest>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHelloStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.registerandlogin.SteamRequest.getDefaultInstance()))
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.grpc.registerandlogin.SteamRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<io.grpc.registerandlogin.SteamRequest> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                io.grpc.registerandlogin.SteamRequest,
                io.grpc.registerandlogin.SteamRequest>(
  ...
  private static abstract class StreamingGreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.registerandlogin.HelloStreamingProto.getDescriptor();
    }
