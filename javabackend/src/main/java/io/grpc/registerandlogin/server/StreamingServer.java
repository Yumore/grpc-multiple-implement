...
import io.grpc.registerandlogin.grpc.StreamingGreeterGrpc;
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        StreamingGreeterGrpc.StreamingGreeterImplBase svc = new StreamingGreeterGrpc.StreamingGreeterImplBase() {
            ...
            public StreamObserver<StreamRequest> sayHelloStreaming(StreamObserver<StreamReply> responseObserver) {
                ...
                final ServerCallStreamObserver<StreamReply> serverCallStreamObserver = (ServerCallStreamObserver<StreamReply>) responseObserver;
                ...
                return new StreamObserver<StreamRequest>() {
                    ...
                    public void onNext(StreamRequest request) {
                        ...
                        try {
                            ...
                            logger.info("<-- " + message);
                            StreamReply reply = StreamReply.newBuilder().setMessage(message).build();
